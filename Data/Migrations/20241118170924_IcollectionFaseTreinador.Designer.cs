...
namespace tcc_in305b.Data.Migrations
{
    ...
    [Migration("20241118170924_IcollectionFaseTreinador")]
    partial class IcollectionFaseTreinador
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("tcc_in305b.Models.FaseTreinador", b =>
                {
                    ...
                    b.Property<int?>("FaseId1")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("TreinadorId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("tcc_in305b.Models.FaseTreinador", b =>
                {
                    ...
                    b.HasOne("tcc_in305b.Models.Fase", null)
                        .WithMany("FaseTreinadores")
                        .HasForeignKey("FaseId1");
                    ...
                    b.HasOne("tcc_in305b.Models.Treinador", null)
                        .WithMany("FaseTreinadores")
                        .HasForeignKey("TreinadorId1");
