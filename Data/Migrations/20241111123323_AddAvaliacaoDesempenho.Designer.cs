...
namespace tcc_in305b.Data.Migrations
{
    ...
    [Migration("20241111123323_AddAvaliacaoDesempenho")]
    partial class AddAvaliacaoDesempenho
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tcc_in305b.Models.AvaliacaoDesempenho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<double>("NotaComunicacao")
                        .HasColumnType("REAL");

                    b.Property<double>("NotaControleMapa")
                        .HasColumnType("REAL");

                    b.Property<double>("NotaGeral")
                        .HasColumnType("REAL");

                    b.Property<double>("NotaMira")
                        .HasColumnType("REAL");

                    b.Property<double>("NotaNocao")
                        .HasColumnType("REAL");
                    ...
                    b.ToTable("AvaliacaoDesempenhos");
                });
            ...
            modelBuilder.Entity("tcc_in305b.Models.PartidaFase", b =>
                {
                    ...
                    b.HasKey("FaseId", "PartidaId");

                    b.HasIndex("PartidaId");

                    b.ToTable("PartidaFases");
                });
            ...
            modelBuilder.Entity("tcc_in305b.Models.RoundEquipe", b =>
                {
                    b.Property<int>("RoundId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("RoundId", "EquipeId");

                    b.HasIndex("EquipeId");

                    b.ToTable("RoundEquipe");
                });
            ...
            modelBuilder.Entity("tcc_in305b.Models.TorneioFase", b =>
                {
                    b.Property<int>("FaseId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("FaseId", "TorneioId");

                    b.HasIndex("TorneioId");

                    b.ToTable("TorneioFases");
                });
            ...
            modelBuilder.Entity("tcc_in305b.Models.Fase", b =>
                {
                    b.Navigation("PartidaFases");

                    b.Navigation("Players");

                    b.Navigation("TorneioFases");
            ...
            modelBuilder.Entity("tcc_in305b.Models.Player", b =>
                {
                    b.Navigation("AvaliacaoDesempenhos");
