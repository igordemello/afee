...
namespace tcc_in305b.Data.Migrations
{
    ...
    [Migration("20250101043104_AddPlayerHistorico")]
    partial class AddPlayerHistorico
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tcc_in305b.Models.AnaliseSelecao", b =>
                {
                    b.Property<int>("AnaliseId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("AnaliseId", "SelecaoId");

                    b.HasIndex("SelecaoId");

                    b.ToTable("AnaliseSelecoes");
                });
            ...
            modelBuilder.Entity("tcc_in305b.Models.PlayerHistorico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("tcc_in305b.Models.Torneio", b =>
                {
                    ...
                    b.Property<int>("QuantidadeEquipes")
                        .HasColumnType("INTEGER");
